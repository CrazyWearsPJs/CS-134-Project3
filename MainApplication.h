...
protected:
    ...
    void collisionDetectionPlayerWall();

    void collisionDetectionPlayerItemHelper(Vector3 rayPos);

    void collisionDetectionPlayerItem();

    void collisionDetectionPlayerWallHelper(Vector3 rayPos);
    ...
    void spawnItemRandomly(Vector3);
    
    void spawnItem(Vector3, item_type); 

    void spawnWall(Vector3);
